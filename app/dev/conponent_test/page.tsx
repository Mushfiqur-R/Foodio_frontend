...
export default function FoodioMenuManagement() {
      ...
      <div className="w-[170px] bg-[#F5F5F0] border-r border-[#E6E2D8] flex flex-col">
        ...
        <nav className="flex-1 px-3">
          ...
          <button
            ...
            className="w-full flex items-center gap-2 px-4 py-2.5 rounded-lg text-sm font-medium text-[#7A7A7A] hover:bg-[#E6E2D8] transition"
          >
            <span className="text-base">📦</span>
            Orders
          </button>
        ...
        <div className="p-8">
          ...
          <div className="bg-white rounded-lg border border-[#E6E2D8] p-6">
            ...
            {activeTab === 'menuItems' && (
              ...
              <table className="w-full  border-[#E6E2D8] rounded-[12px]">
                <thead>
                  <tr className="border-b border-[#E6E2D8] bg-[#E6E2D8]">
