    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40">
      <div className="relative w-full max-w-[400px] rounded-[12px] bg-white p-[24px] shadow-2xl">
        ...
        <div className="mb-[16px] flex items-center justify-between">
          <div>
            <h2 className="text-[18px] font-semibold text-[#1A1A1A]">Order Details</h2>
            {orderDetails && (
        ...
        {!isLoading && !error && orderDetails && (
          <div className="space-y-[16px]">
            {/* Address */}
            <div>
              <p className="text-[13px] font-medium text-[#333333] mb-[4px]">Address</p>
              <p className="text-[13px] text-[#7A7A7A]">{orderDetails.user.address}</p>
            </div>
            ...
            {/* Items */}
            <div>
              <p className="text-[13px] font-medium text-[#333333] mb-[8px]">Items</p>
